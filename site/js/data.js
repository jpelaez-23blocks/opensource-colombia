...
(function () {
  ...
  const C = {
    ...
    juan: { name: "Juan Peláez", github: "jpelaez-23blocks", area: "Agentes IA, orquestación" },
  ...
  window.PROJECTS = [
    ...
    },
    {
      ...
      description: {
        es: "Orquestador de agentes de IA con panel web: memoria semántica, consultas al grafo de código y mensajería entre agentes.",
        en: "AI agent orchestrator with a web dashboard: semantic memory, code-graph queries and agent-to-agent messaging.",
        pt: "Orquestrador de agentes de IA com painel web: memória semântica, consultas ao grafo de código e mensageria entre agentes.",
      },
    },
    {
      ...
      description: {
        es: "Estándar abierto de mensajería entre agentes de IA, con sobres firmados con Ed25519 y federación entre proveedores.",
        en: "Open standard for agent-to-agent messaging, with Ed25519-signed envelopes and federation across providers.",
        pt: "Padrão aberto de mensageria entre agentes de IA, com envelopes assinados com Ed25519 e federação entre provedores.",
      },
    },
    {
      name: "lolabot",
      ...
      description: {
        es: "Asistente tipo jefe de gabinete para Claude Code: correo, memoria semántica entre sesiones y gestión de tareas.",
        en: "Chief-of-staff assistant for Claude Code: email, semantic memory across sessions and task management.",
        pt: "Assistente tipo chefe de gabinete para Claude Code: e-mail, memória semântica entre sessões e gestão de tarefas.",
      },
    },
    {
      name: "Agent Identity",
      ...
      description: {
        es: "Identidad, autenticación y autorización para agentes de IA usando claves Ed25519 e intercambio de tokens OAuth 2.0.",
        en: "Identity, authentication and authorization for AI agents using Ed25519 keys and OAuth 2.0 token exchange.",
        pt: "Identidade, autenticação e autorização para agentes de IA usando chaves Ed25519 e troca de tokens OAuth 2.0.",
      },
    },
    {
      ...
      tags: ["Protocol", "UI"],
      description: {
        es: "Protocolo abierto para interacciones estructuradas entre interfaces de usuario y agentes de IA.",
        en: "Open protocol for structured interactions between user interfaces and AI agents.",
        pt: "Protocolo aberto para interações estruturadas entre interfaces de usuário e agentes de IA.",
      },
    },
    {
      ...
      description: {
        es: "Constructor de plugins para AI Maestro: ensambla personalidades, skills, mensajería e identidad desde un manifiesto.",
        en: "Plugin builder for AI Maestro: assembles personalities, skills, messaging and identity from a manifest.",
        pt: "Construtor de plugins para o AI Maestro: monta personalidades, skills, mensageria e identidade a partir de um manifesto.",
      },
    },
  ];
})();
